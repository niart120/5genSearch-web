 ...
 */
export function generate_egg_search_tasks(context: DatetimeSearchContext, date_range: DateRangeParams, egg_params: EggGenerationParams, gen_config: GenerationConfig, filter: EggFilter | null | undefined, worker_count: number): EggDatetimeSearchParams[];
 ...
 * - `worker_count`: Worker 数
 */
export function generate_trainer_info_search_tasks(context: DatetimeSearchContext, filter: TrainerInfoFilter, game_start: GameStartConfig, date_range: DateRangeParams, worker_count: number): TrainerInfoSearchParams[];
