...
export const generate_egg_search_tasks: (a: any, b: any, c: any, d: any, e: number, f: number) => [number, number];
export const generate_mtseed_search_tasks: (a: any, b: number, c: number, d: any, e: number) => [number, number];
