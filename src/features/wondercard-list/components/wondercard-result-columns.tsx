...
/**
 * WonderCardResultView テーブル列定義
 *
 * 配達員の個体生成結果を DataTable で表示するための ColumnDef。
 */
...
const columnHelper = createColumnHelper<WonderCardResultView>();

const IV_VALUE_ACCESSORS: ReadonlyArray<(result: WonderCardResultView) => number> = [
...
const STAT_VALUE_ACCESSORS: ReadonlyArray<(result: WonderCardResultView) => number | undefined> = [
...
interface WonderCardResultColumnsOptions {
  onSelect?: (result: WonderCardResultView) => void;
  statMode?: StatDisplayMode;
  locale?: SupportedLocale;
}

function createWonderCardResultColumns(options: WonderCardResultColumnsOptions = {}) {
...
export { createWonderCardResultColumns };
export type { WonderCardResultColumnsOptions };
