...
また `template-selection-dialog.tsx` の説明文 `"Select seed templates to apply to Target Seeds."` は、コンポーネント名由来の表現でユーザーにとって不明瞭なため、`"Select MT Seed templates to apply."` に変更した。
