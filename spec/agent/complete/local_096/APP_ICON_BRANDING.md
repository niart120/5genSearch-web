...
- [x] アイコン原本を `public/icon.png` に配置
- [x] favicon (16x16, 32x32) を生成・配置
- [x] Apple Touch Icon (180x180) を生成・配置
- [x] PWA 用アイコン (192x192, 512x512) を生成・配置
- [x] `public/vite.svg` を削除
- [x] `public/manifest.json` を作成
- [x] `index.html` の `<head>` を更新
- [x] `header.tsx` にアイコン画像を追加し、タイトルスタイルを変更
- [x] ダークモードでの視認性を確認
- [x] モバイル表示でのレイアウト崩れがないことを確認
- [x] ビルドが通ることを確認 (`pnpm build`)
